...
- Read `references/revision-checklist.md` when performing a full manuscript pass or when the task involves scientific rigor, citations, figures, equations, or data consistency.
...
3. Apply the checklist sequentially: scope setup, precision, concision, tone, scientific rigor, and final audit.
